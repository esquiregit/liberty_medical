<?php
	...
	class StoolCS {
        ...
        // create a stool_cs record
        public static function create_stool_cs($patient_id, $culture, $bacteria_one, $bacteria_two, $bacteria_three, $antibiotics_one, $antibiotics_two, $antibiotics_three, $antibiotics_four, $antibiotics_five, $antibiotics_six, $antibiotics_seven, $antibiotics_eight, $antibiotics_nine, $antibiotics_ten, $antibiotics_eleven, $antibiotics_twelve, $antibiotics_thirteen, $antibiotics_fourteen, $antibiotics_fifteen, $antibiotics_sixteen, $antibiotics_seventeen, $antibiotics_eighteen, $antibiotics_nineteen, $antibiotics_twenty, $antibiotics_twenty_one, $antibiotics_twenty_two, $antibiotics_twenty_three, $antibiotics_twenty_four, $sensitivity_one, $sensitivity_two, $sensitivity_three, $sensitivity_four, $sensitivity_five, $sensitivity_six, $sensitivity_seven, $sensitivity_eight, $sensitivity_nine, $sensitivity_ten, $sensitivity_eleven, $sensitivity_twelve, $sensitivity_thirteen, $sensitivity_fourteen, $sensitivity_fifteen, $sensitivity_sixteen, $sensitivity_seventeen, $sensitivity_eighteen, $sensitivity_nineteen, $sensitivity_twenty, $sensitivity_twenty_one, $sensitivity_twenty_two, $sensitivity_twenty_three, $sensitivity_twenty_four, $comments, $added_by, $conn){
            $invoice_id               = Methods::get_invoice_id('Stool C/S', $conn);
            $amount                   = Charge::read_charge('73', $conn);
        ...
        // fetch all stool_cs records
        public static function read_stool_cs($conn){
            try{
                $query = $conn->prepare('SELECT scs.id, scs.invoice_id, scs.patient_id, scs.culture, scs.bacteria_one, scs.bacteria_two, scs.bacteria_three, scs.antibiotics_one, scs.antibiotics_two, scs.antibiotics_three, scs.antibiotics_four, scs.antibiotics_five, scs.antibiotics_six, scs.antibiotics_seven, scs.antibiotics_eight, scs.antibiotics_nine, scs.antibiotics_ten, scs.antibiotics_eleven, scs.antibiotics_twelve, scs.antibiotics_thirteen, scs.antibiotics_fourteen, scs.antibiotics_fifteen, scs.antibiotics_sixteen, scs.antibiotics_seventeen, scs.antibiotics_eighteen, scs.antibiotics_nineteen, scs.antibiotics_twenty, scs.antibiotics_twenty_one, scs.antibiotics_twenty_two, scs.antibiotics_twenty_three, scs.antibiotics_twenty_four, scs.sensitivity_one, scs.sensitivity_two, scs.sensitivity_three, scs.sensitivity_four, scs.sensitivity_five, scs.sensitivity_six, scs.sensitivity_seven, scs.sensitivity_eight, scs.sensitivity_nine, scs.sensitivity_ten, scs.sensitivity_eleven, scs.sensitivity_twelve, scs.sensitivity_thirteen, scs.sensitivity_fourteen, scs.sensitivity_fifteen, scs.sensitivity_sixteen, scs.sensitivity_seventeen, scs.sensitivity_eighteen, scs.sensitivity_nineteen, scs.sensitivity_twenty, scs.sensitivity_twenty_one, scs.sensitivity_twenty_two, scs.sensitivity_twenty_three, scs.sensitivity_twenty_four, scs.comments, scs.added_by, scs.date_added, p.date_of_birth, p.gender, p.first_name as pfirst_name, p.middle_name as pmiddle_name, p.last_name as plast_name, u.first_name as ufirst_name, u.other_name as uother_name, u.last_name as ulast_name FROM stool_cs scs INNER JOIN patients p ON scs.patient_id = p.patient_id INNER JOIN users u ON scs.added_by = u.staff_id');
                $query->execute();
        ...
        // fetch a stool_cs record
        public static function read_a_stool_cs($id, $conn){
            try{
                $query = $conn->prepare('SELECT scs.id, scs.invoice_id, scs.patient_id, scs.culture, scs.bacteria_one, scs.bacteria_two, scs.bacteria_three, scs.antibiotics_one, scs.antibiotics_two, scs.antibiotics_three, scs.antibiotics_four, scs.antibiotics_five, scs.antibiotics_six, scs.antibiotics_seven, scs.antibiotics_eight, scs.antibiotics_nine, scs.antibiotics_ten, scs.antibiotics_eleven, scs.antibiotics_twelve, scs.antibiotics_thirteen, scs.antibiotics_fourteen, scs.antibiotics_fifteen, scs.antibiotics_sixteen, scs.antibiotics_seventeen, scs.antibiotics_eighteen, scs.antibiotics_nineteen, scs.antibiotics_twenty, scs.antibiotics_twenty_one, scs.antibiotics_twenty_two, scs.antibiotics_twenty_three, scs.antibiotics_twenty_four, scs.sensitivity_one, scs.sensitivity_two, scs.sensitivity_three, scs.sensitivity_four, scs.sensitivity_five, scs.sensitivity_six, scs.sensitivity_seven, scs.sensitivity_eight, scs.sensitivity_nine, scs.sensitivity_ten, scs.sensitivity_eleven, scs.sensitivity_twelve, scs.sensitivity_thirteen, scs.sensitivity_fourteen, scs.sensitivity_fifteen, scs.sensitivity_sixteen, scs.sensitivity_seventeen, scs.sensitivity_eighteen, scs.sensitivity_nineteen, scs.sensitivity_twenty, scs.sensitivity_twenty_one, scs.sensitivity_twenty_two, scs.sensitivity_twenty_three, scs.sensitivity_twenty_four, scs.comments, scs.added_by, scs.date_added, p.date_of_birth, p.gender, p.first_name as pfirst_name, p.middle_name as pmiddle_name, p.last_name as plast_name, u.first_name as ufirst_name, u.other_name as uother_name, u.last_name as ulast_name FROM stool_cs scs INNER JOIN patients p ON scs.patient_id = p.patient_id INNER JOIN users u ON scs.added_by = u.staff_id WHERE scs.id = :id');
                $query->execute([':id' => $id]);
