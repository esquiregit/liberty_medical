<?php
	...
	class StoolRE {
        ...
        public static function create_stool_re($patient_id, $row_one_one, $ova_one, $ova_two, $row_three_one, $row_three_two, $row_four_one, $row_four_two, $larvae_one, $larvae_two, $cyst_one, $cyst_two, $row_seven_one, $row_seven_two, $row_eight_one, $row_eight_two, $vegetative_form_one, $vegetative_form_two, $row_ten_one, $row_ten_two, $row_eleven_one, $row_eleven_two, $red_blood_cells, $white_blood_cells, $comments, $added_by, $conn){
            ...
            $row_one_one         = implode(', ', $row_one_one);
            $ova_one             = implode(', ', $ova_one);
            $ova_two             = implode(', ', $ova_two);
            $row_three_one       = implode(', ', $row_three_one);
            $row_three_two       = implode(', ', $row_three_two);
            $row_four_one        = implode(', ', $row_four_one);
            $row_four_two        = implode(', ', $row_four_two);
            $larvae_one          = implode(', ', $larvae_one);
            $larvae_two          = implode(', ', $larvae_two);
            $cyst_one            = implode(', ', $cyst_one);
            $cyst_two            = implode(', ', $cyst_two);
            $row_seven_one       = implode(', ', $row_seven_one);
            $row_seven_two       = implode(', ', $row_seven_two);
            $row_eight_one       = implode(', ', $row_eight_one);
            $row_eight_two       = implode(', ', $row_eight_two);
            $vegetative_form_one = implode(', ', $vegetative_form_one);
            $vegetative_form_two = implode(', ', $vegetative_form_two);
            $row_ten_one         = implode(', ', $row_ten_one);
            $row_ten_two         = implode(', ', $row_ten_two);
            $row_eleven_one      = implode(', ', $row_eleven_one);
            $row_eleven_two      = implode(', ', $row_eleven_two);
            $red_blood_cells     = implode(', ', $red_blood_cells);
            $white_blood_cells   = implode(', ', $white_blood_cells);
