...
function AddPleuralFluid({ patient, closeModal }) {
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_pleural_fluid', values, { signal: signal })
            .then(response => {
...
export default AddPleuralFluid;
