...
import { getTodaysDate, getGramStains, getZNStains, getAppearances, get_pus_cells_options } from '../../../../../Extras/Functions';
...
function AddSputumAFB({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('sputumafb'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_sputum_afb', values, { signal: signal })
            .then(response => {
