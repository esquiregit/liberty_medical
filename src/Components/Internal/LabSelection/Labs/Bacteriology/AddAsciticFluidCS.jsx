...
function AddAsciticFluidCS({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('AsciticFluidCS'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_ascitic_fluid', values, { signal: signal })
            .then(response => {
...
export default AddAsciticFluidCS;
