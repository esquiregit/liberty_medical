...
import { getTodaysDate, getFungalElements, getAntibiotics, getGramStains, getBacterias, getZNStains, getCultures } from '../../../../Extras/Functions';
...
function AddAspirateFluidCS({ patient, closeModal }) {
    const staff               = useSelector(state => state.authReducer.staff);
    const classes             = styles();
    const gramStains          = getGramStains();
    const znStains            = getZNStains();
    const fungalElements      = getFungalElements();
    ...
    const handleClose  = () => { setOpen(false); closeModal('AspirateFluidCS'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_aspirate_fluid', values, { signal: signal })
            .then(response => {
                            ...
                            <DialogContent dividers>
                                ...
                                <table id="lab-table">
                                    <tbody>
                                        <tr>
                                            <td></td>
                                            <th className="text-left" colSpan="3">Microscopy</th>
                                        </tr>
                                        <tr>
                                            <td width="25%"></td>
                                            <td width="25%" className="text-left">Gram Stain</td>
                                            <td width="25%">
                                                <FormikTextField
                                                    select
                                                    size="small"
                                        ...
                                        <tr>
                                            <td></td>
                                            <td className="text-left">Z-N Stain</td>
                                            <td>
                                                <FormikTextField
                                                    select
                                                    size="small"
                                        ...
                                        <tr>
                                            <td></td>
                                            <td className="text-left">Fungal Element</td>
                                            <td>
                                                <FormikTextField
                                                    select
                                                    size="small"
                                                    ...
                                                    id="fungal_element"
                                                    name="fungal_element">
                                                    {fungalElements.map((option, index) => (
                                                        <MenuItem key={index} value={option.value}>
                                                            {option.label}
                                                        </MenuItem>
                                                    ))}
...
export default AddAspirateFluidCS;
