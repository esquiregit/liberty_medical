...
function AddSkinSnip({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('SkinSnip'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_skin_snip', values, { signal: signal })
            .then(response => {
                        ...
                        <Form>
                            ...
                            <DialogContent dividers>
                                ...
                                <table id="lab-table">
                                    <tbody>
                                        <tr>
                                            <th width="15%">Skin Snip</th>
                                            <td width="20%">Onchocerca Volvulus</td>
                                            <td width="20%">
                                                <FormikTextField
                                                    size="small"
                                                    variant="outlined"
                                                    margin="normal"
                                                    fullWidth
                                                    id="onchocerca_volvulus"
                                                    name="onchocerca_volvulus" />
                                            </td>
                                            <td width="20%">M. Streptocerca</td>
                                            <td width="20%">
                                                <FormikTextField
                                                    size="small"
                                                    variant="outlined"
