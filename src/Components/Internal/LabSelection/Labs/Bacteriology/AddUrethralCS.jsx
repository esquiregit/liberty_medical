...
import { getTodaysDate, getAntibiotics, getBacterias, getCultures, getGramStains } from '../../../../Extras/Functions';
...
function AddUrethralCS({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('urethralcs'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_urethral_cs', values, { signal: signal })
            .then(response => {
                        ...
                        <Form>
                            ...
                            <DialogContent dividers>
                                ...
                                <table id="lab-table">
                                    <tbody>
                                        <tr>
                                            <td width="20%" className="text-left">Gram Stain</td>
                                            <td>
                                                <FormikTextField
                                                    select
                                                    size="small"
                                                    ...
                                                    id="gram_stain"
                                                    name="gram_stain">
                                                    {getGramStains().map((option, index) => (
