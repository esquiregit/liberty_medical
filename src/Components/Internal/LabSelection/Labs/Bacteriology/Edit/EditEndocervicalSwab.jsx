...
import { getTodaysDate, getTVaginalis, getAntibiotics, getGramStains, getBacterias, getCultures } from '../../../../../Extras/Functions';
...
function EditEndocervicalSwab({ lab, closeModal, closeExpandable }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('EndocervicalSwab'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_endocervical_swab', values, { signal: signal })
            .then(response => {
                if(response.data[0].status.toLowerCase() === 'success') {
                    setSuccess(true);
                    setMessage(response.data[0].message);
                    setTimeout(() => { closeModal('EndocervicalSwab'); }, 1050);
                } else {
                    setError(true);
                    setMessage(response.data[0].message);
                }
                            ...
                            <DialogContent dividers>
                                ...
                                <table id="lab-table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td className="text-left">T Vaginalis</td>
                                            <td>
                                                <FormikTextField
                                                    select
                                                    size="small"
...
export default EditEndocervicalSwab;
