                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Endocervical Swab</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: '1px solid #333',backgroundColor: '#eee'}]}>
                            <Text style={styles.two_column_one}>Pus Cells Per HPS</Text>
                            <Text style={styles.two_column_two}>{lab.pus_cells_per_hps}</Text>
                            <Text style={styles.two_column_one}>RBCs Per HPF</Text>
                            <Text style={styles.two_column_two}>{lab.rbcs_per_hpf}</Text>
                        </View>
                        <View style={styles.table_column}>
                            <Text style={styles.two_column_one}>Epithelial Cells Per HPF</Text>
                            <Text style={styles.two_column_two}>{lab.epitheleal_cells_per_hpf}</Text>
                            <Text style={styles.two_column_one}>T Vaginalis</Text>
                            <Text style={styles.two_column_two}>{lab.t_vaginalis}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
                            <Text style={styles.two_column_one}>Yeast-Like Cells</Text>
                            <Text style={styles.two_column_two}>{lab.yeast_like_cells}</Text>
                        ...
                        <View style={styles.table_column}>
                            ...
                            <Text style={styles.two_column_two_wide}>{lab.culture}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
