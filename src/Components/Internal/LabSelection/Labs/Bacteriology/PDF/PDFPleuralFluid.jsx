                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Pleural Fluid</Text>
                        ...
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.colour}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Gram Stain"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.gram_stain}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Appearance"}</Text>
                            <Text style={styles.table_column_three}>{lab.appearance}</Text>
                            <Text style={styles.table_column_three}>{lab.appearance_dropdown}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Acid Fast Bacilli"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.acid_fast_bacilli}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Glucose"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.glucose}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Pleural Fluid Albumin"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.pleural_fluid_albumin}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Total Protein"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.total_protein}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"LDH"}</Text>
                            <Text style={[styles.table_column_wide, {textAlign: 'left'}]}>{lab.ldh}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Total WBC"}</Text>
                            <Text style={styles.table_column_three}>{lab.total_wbc_one}</Text>
                            <Text style={styles.table_column_three}>{lab.total_wbc_two}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Lymphocytes"}</Text>
                            <Text style={styles.table_column_three}>{lab.lymphocytes_one}</Text>
                            <Text style={styles.table_column_three}>{lab.lymphocytes_two}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Monocytes"}</Text>
                            <Text style={styles.table_column_three}>{lab.monocytes_one}</Text>
                            <Text style={styles.table_column_three}>{lab.monocytes_two}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Granulocytes"}</Text>
                            <Text style={styles.table_column_three}>{lab.granulocytes_one}</Text>
                            <Text style={styles.table_column_three}>{lab.granulocytes_two}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
