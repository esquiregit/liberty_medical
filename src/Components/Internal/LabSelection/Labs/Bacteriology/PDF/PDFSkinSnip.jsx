                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>SkinSnip CS</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: '1px solid #444'}]}>
                            <Text style={styles.table_column_six_one}>Onchocerca Volvulus</Text>
                            <Text style={styles.table_column_six_wide}>{lab.onchocerca_volvulus}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: '1px solid #444'}]}>
                            <Text style={styles.table_column_six_one}>M. Streptocerca</Text>
                            <Text style={styles.table_column_six_wide}>{lab.m_streptocerca}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: '1px solid #444'}]}>
                            <Text style={styles.table_column_six_one}>Culture</Text>
                        ...
                        <View style={styles.table_column}>
                            <Text style={styles.table_column_six}>Bacteria</Text>
                            <Text style={[styles.table_column_six, {textAlign: 'left'}]}>{lab.bacteria_three}</Text>
                            <Text style={styles.table_column_six}>Antibiotics</Text>
                            <Text style={styles.table_column_six}>Sensitivity</Text>
                            <Text style={styles.table_column_six}>Antibiotics</Text>
                            <Text style={styles.table_column_six}>Sensitivity</Text>
                        ...
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_seventeen}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_seventeen}</Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_eighteen}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_eighteen}</Text>
                        </View>
                        <View style={styles.table_column}>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_nineteen}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_nineteen}</Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_twenty}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_twenty}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_twenty_one}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_twenty_one}</Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_twenty_two}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_twenty_two}</Text>
                        </View>
                        <View style={styles.table_column}>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}></Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_twenty_three}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_twenty_three}</Text>
                            <Text style={styles.table_column_six}>{lab.antibiotics_twenty_four}</Text>
                            <Text style={styles.table_column_six}>{lab.sensitivity_twenty_four}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
                            <Text style={styles.table_column_six_one}>Comments</Text>
