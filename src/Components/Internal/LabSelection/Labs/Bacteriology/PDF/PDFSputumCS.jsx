                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Sputum CS CS</Text>
                        ...
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: '1px solid #333'}]}>
                            <Text style={styles.two_column_one}>Appearance</Text>
                            <Text style={styles.two_column_two}>{lab.appearance}</Text>
                        </View>
