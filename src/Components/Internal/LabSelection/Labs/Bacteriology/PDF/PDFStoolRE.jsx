                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={[styles.two_column, {marginBottom: -0}]}>
                            <Text style={styles.two_column_left}>Stool RE</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_wide}>{lab.ova_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Ova"}</Text>
                            <Text style={styles.table_column_three}>{lab.ova_one}</Text>
                            <Text style={styles.table_column_three}>{lab.ova_two}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_three_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_three_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_four_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_four_one}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Larvae"}</Text>
                            <Text style={styles.table_column_three}>{lab.larvae_one}</Text>
                            <Text style={styles.table_column_three}>{lab.larvae_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Cyst"}</Text>
                            <Text style={styles.table_column_three}>{lab.cyst_one}</Text>
                            <Text style={styles.table_column_three}>{lab.cyst_one}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_seven_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_seven_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_eight_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_eight_one}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Vegetative Form"}</Text>
                            <Text style={styles.table_column_three}>{lab.vegetative_form_one}</Text>
                            <Text style={styles.table_column_three}>{lab.vegetative_form_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_ten_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_ten_one}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{""}</Text>
                            <Text style={styles.table_column_three}>{lab.row_eleven_one}</Text>
                            <Text style={styles.table_column_three}>{lab.row_eleven_one}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Red Blood Cells"}</Text>
                            <Text style={styles.table_column_wide}>{lab.red_blood_cells}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"White Blood Cells"}</Text>
                            <Text style={styles.table_column_wide}>{lab.white_blood_cells}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
