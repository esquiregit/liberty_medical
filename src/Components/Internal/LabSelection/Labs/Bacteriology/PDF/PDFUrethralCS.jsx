                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Urethral CS</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: '1px solid #444'}]}>
                            <Text style={styles.table_column_six_half}>Gram Stain</Text>
                            <Text style={styles.table_column_six_half}>{lab.gram_stain}</Text>
                            <Text style={styles.table_column_six_half}>Culture</Text>
                            <Text style={styles.table_column_six_half}>{lab.culture}</Text>
                        </View>
