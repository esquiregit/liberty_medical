                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Urine CS</Text>
                        ...
                        <View style={[styles.table_column, {marginTop: -22,borderTop: '1px solid #333',backgroundColor: '#eee'}]}>
                            <Text style={styles.two_column_one}>Pus Cells Per HPS</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.pus_cells_per_hps}</Text>
                            <Text style={styles.two_column_one}>RBCs Per HPF</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.rbcs_per_hpf}</Text>
                        </View>
                        <View style={styles.table_column}>
                            <Text style={styles.two_column_one}>Epithelial Cells Per HPF</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.epitheleal_cells_per_hpf}</Text>
                            <Text style={styles.two_column_one}>Crystals</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.crystals}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
                            <Text style={styles.two_column_one}>Yeast-Like Cells</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.yeast_like_cells}</Text>
                            <Text style={styles.two_column_one}>Cast</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.cast}</Text>
                        </View>
                        <View style={[styles.table_column]}>
                            <Text style={styles.two_column_one}>Gram Stain</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.gram_stain}</Text>
                            <Text style={styles.two_column_one}>Culture</Text>
                            <Text style={[styles.two_column_one, {textAlign: 'left', paddingLeft: 10}]}>{lab.culture}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee'}]}>
