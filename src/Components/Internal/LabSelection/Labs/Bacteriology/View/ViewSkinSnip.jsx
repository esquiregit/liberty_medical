...
import PDFLab from '../PDF/PDFSkinSnip';
import EditLab from '../Edit/EditSkinSnip';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Onchocerca Volvulus: </th>
                                    <td>{lab.onchocerca_volvulus}</td>
                                    <th>M. Streptocerca: </th>
                                    <td>{lab.m_streptocerca}</td>
                                </tr>
                                <tr>
                                    <th>Culture: </th>
                                    <td colSpan="3">{lab.culture}</td>
                                </tr>
                            </tbody>
                        </table>
