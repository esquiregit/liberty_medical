...
import PDFLab from '../PDF/PDFWoundCS';
import EditLab from '../Edit/EditWoundCS';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>Z-N Stain: </th>
                                    <td colSpan="2">{lab.zn_stain}</td>
                                </tr>
                                <tr>
                                    <th>Pus Cells: </th>
                                    <td colSpan="2">{lab.pus_cells}</td>
                                    <th>Fungal Element: </th>
                                    <td colSpan="2">{lab.fungal_element}</td>
                                </tr>
                                <tr>
                                    <th>Culture: </th>
