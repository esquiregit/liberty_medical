...
function AddISE({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('ISE'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_ise', values, { signal: signal })
            .then(response => {
