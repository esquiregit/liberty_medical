...
function AddBueCreatinineEgfr({ patient, closeModal }) {
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_bue_creatinine_egfr', values, { signal: signal })
            .then(response => {
...
export default AddBueCreatinineEgfr;
