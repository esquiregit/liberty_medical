...
function AddHypersensitiveCPR({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('HypersensitiveCPR'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_hypersensitive_cpr', values, { signal: signal })
            .then(response => {
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="text-centre">
                                                Lower Risk: &lt; 2.0 mg/L<br />
                                                Higher Risk: &gt; 2.0 mg/L<br />
                                                Acute inflammation: &gt; 10.0 mg/L<br />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="text-centre pt-20 pb-20" colSpan="5">
                                                HS-CPR is more precise than standard CPR when measuring baseline/normal concentrations and enables a measure of chronic inflammation.<br />
                                                HS-CPR is recommended as a bio marker for cardiovascular risk assessment only
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Comments</td>
...
export default AddHypersensitiveCPR;
