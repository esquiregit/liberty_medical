...
function AddProteinElectrophoresis({ patient, closeModal }) {
    ...
    const initialValues = {
        ...
        albumin_flag : '',
        alpha_1_globulin: '',
        alpha_1_globulin_flag : '',
        alpha_2_globulin: '',
        alpha_2_globulin_flag : '',
        beta_1_globulin: '',
        beta_1_globulin_flag : '',
        beta_2_globulin: '',
        beta_2_globulin_flag : '',
        gamma_globulin: '',
        gamma_globulin_flag : '',
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_protein_electrophoresis', values, { signal: signal })
            .then(response => {
...
export default AddProteinElectrophoresis;
