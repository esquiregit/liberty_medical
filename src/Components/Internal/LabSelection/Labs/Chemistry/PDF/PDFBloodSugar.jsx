                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Fasting Blood Sugar"}</Text>
                            <Text style={styles.table_column_two}>{lab.fasting_blood_sugar}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Random Blood Sugar"}</Text>
                            <Text style={styles.table_column_two}>{lab.random_blood_sugar}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"2HPP Blood Sugar"}</Text>
                            <Text style={styles.table_column_two}>{lab.two_hpp_blood_sugar}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
