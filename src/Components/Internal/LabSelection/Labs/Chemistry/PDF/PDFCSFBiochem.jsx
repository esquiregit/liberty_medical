                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>CSF Biochem</Text>
                        ...
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
