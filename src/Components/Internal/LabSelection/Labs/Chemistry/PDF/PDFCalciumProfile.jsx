                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Calcium Profile</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"s-Calcium (Total)"}</Text>
                            <Text style={styles.table_column_three}>{lab.s_calcium_total}</Text>
                            <Text style={styles.table_column_three}>{lab.s_calcium_total_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"s-Ionized Calcium (Calc)"}</Text>
                            <Text style={styles.table_column_three}>{lab.s_ionized_calcium_calc}</Text>
                            <Text style={styles.table_column_three}>{lab.s_ionized_calcium_calc_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"s-Albumin"}</Text>
                            <Text style={styles.table_column_three}>{lab.s_albumin}</Text>
                            <Text style={styles.table_column_three}>{lab.s_albumin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"s-Total Protein"}</Text>
                            <Text style={styles.table_column_three}>{lab.s_total_protein}</Text>
                            <Text style={styles.table_column_three}>{lab.s_total_protein_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Corrected Calcium (Calc)"}</Text>
                            <Text style={styles.table_column_three}>{lab.corrected_calcium_calc}</Text>
                            <Text style={styles.table_column_three}>{lab.corrected_calcium_calc_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
