                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"AST"}</Text>
                            <Text style={styles.table_column_two}>{lab.ast}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"ALT"}</Text>
                            <Text style={styles.table_column_two}>{lab.alt}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Creatinine Kinase"}</Text>
                            <Text style={styles.table_column_two}>{lab.creatinine_kinase}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Troponin"}</Text>
                            <Text style={styles.table_column_two}>{lab.troponin}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
