                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Folate B12</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Folate"}</Text>
                            <Text style={styles.table_column_two}>{lab.folate}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Vitamin B12"}</Text>
                            <Text style={styles.table_column_two}>{lab.vitamin_b_12}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
