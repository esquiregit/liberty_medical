                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Blood Sugar</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',borderBottom: '1px solid #000',marginBottom: 5}]}>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Amylase"}</Text>
                            <Text style={styles.table_column_two}>{lab.amylase}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"LDH"}</Text>
                            <Text style={styles.table_column_two}>{lab.ldh}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Creatine Kinase"}</Text>
                            <Text style={styles.table_column_two}>{lab.creatine_kinase}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Creatinine"}</Text>
                            <Text style={styles.table_column_two}>{lab.creatinine}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Uric Acid"}</Text>
                            <Text style={styles.table_column_two}>{lab.uric_acid}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Calcium"}</Text>
                            <Text style={styles.table_column_two}>{lab.calcium}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Phosphorus"}</Text>
                            <Text style={styles.table_column_two}>{lab.phosphorus}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Magnessium"}</Text>
                            <Text style={styles.table_column_two}>{lab.magnessium}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"FBS Glucose"}</Text>
                            <Text style={styles.table_column_two}>{lab.fbs_glucose}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Globulin"}</Text>
                            <Text style={styles.table_column_two}>{lab.globulin}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Bili, Indirect"}</Text>
                            <Text style={styles.table_column_two}>{lab.bili_indirect}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"% Glyco-HBG"}</Text>
                            <Text style={styles.table_column_two}>{lab.glyco_hbg}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
