                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Iron Study</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Iron"}</Text>
                            <Text style={styles.table_column_three}>{lab.iron}</Text>
                            <Text style={styles.table_column_three}>{lab.iron_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"TIBC"}</Text>
                            <Text style={styles.table_column_three}>{lab.tibc}</Text>
                            <Text style={styles.table_column_three}>{lab.tibc_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Transferrin SAT"}</Text>
                            <Text style={styles.table_column_three}>{lab.transferrin_sat}</Text>
                            <Text style={styles.table_column_three}>{lab.transferrin_sat_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Ferritin"}</Text>
                            <Text style={styles.table_column_three}>{lab.ferritin}</Text>
                            <Text style={styles.table_column_three}>{lab.ferritin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
