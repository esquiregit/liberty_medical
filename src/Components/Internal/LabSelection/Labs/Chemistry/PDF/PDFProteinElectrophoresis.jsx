                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Protein Electrophoresis</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_three}>{lab.total_protein}</Text>
                            <Text style={styles.table_column_three}>{lab.total_protein_flag}</Text>
                        </View>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Alpha 1 Globulin"}</Text>
                            <Text style={styles.table_column_three}>{lab.alpha_1_globulin}</Text>
                            <Text style={styles.table_column_three}>{lab.alpha_1_globulin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Alpha 2 Globulin"}</Text>
                            <Text style={styles.table_column_three}>{lab.alpha_2_globulin}</Text>
                            <Text style={styles.table_column_three}>{lab.alpha_2_globulin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Beta 1 Globulin"}</Text>
                            <Text style={styles.table_column_three}>{lab.beta_1_globulin}</Text>
                            <Text style={styles.table_column_three}>{lab.beta_1_globulin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Beta 2 Globulin"}</Text>
                            <Text style={styles.table_column_three}>{lab.beta_2_globulin}</Text>
                            <Text style={styles.table_column_three}>{lab.beta_2_globulin_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Gamma Globulin"}</Text>
                            <Text style={styles.table_column_three}>{lab.gamma_globulin}</Text>
                            <Text style={styles.table_column_three}>{lab.gamma_globulin_flag}</Text>
                        </View>
                    </View>
                </View>
            </Page>
