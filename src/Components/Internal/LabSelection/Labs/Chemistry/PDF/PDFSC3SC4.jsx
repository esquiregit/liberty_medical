                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>S-C3 S-C4</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"SC3"}</Text>
                            <Text style={styles.table_column_two}>{lab.s_c3}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"SC4"}</Text>
                            <Text style={styles.table_column_two}>{lab.s_c4}</Text>
                        </View>
                    </View>
                </View>
            </Page>
