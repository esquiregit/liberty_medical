                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Serum Lipase</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"S Lipase"}</Text>
                            <Text style={styles.table_column_three}>{lab.s_lipase}</Text>
                            <Text style={styles.table_column_three}>{lab.s_lipase_flag}</Text>
                        </View>
