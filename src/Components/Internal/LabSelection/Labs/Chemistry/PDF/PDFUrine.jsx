                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Urine</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Urine VMA"}</Text>
                            <Text style={styles.table_column_two}>{lab.urine_vma}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Urine Calcium"}</Text>
                            <Text style={styles.table_column_two}>{lab.urine_calcium}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Urine Uric Acid"}</Text>
                            <Text style={styles.table_column_two}>{lab.urine_uric_acid}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Urine Creatinine"}</Text>
                            <Text style={styles.table_column_two}>{lab.urine_creatinine}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Serum Creatinine"}</Text>
                            <Text style={styles.table_column_two}>{lab.serum_creatinine}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"24Hr Urine Volume"}</Text>
                            <Text style={styles.table_column_two}>{lab.twenty_four_hour_urine_volume}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Clearance"}</Text>
                            <Text style={styles.table_column_two}>{lab.clearance}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8}]}>
