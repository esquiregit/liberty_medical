                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Urine ACR</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_three}>{lab.urea_creatinine}</Text>
                            <Text style={styles.table_column_three}>{lab.urea_creatinine_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Micro Albumin (Urine)"}</Text>
                            <Text style={styles.table_column_three}>{lab.micro_albumin_urine}</Text>
                            <Text style={styles.table_column_three}>{lab.micro_albumin_urine_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"UACR"}</Text>
                            <Text style={styles.table_column_three}>{lab.uacr}</Text>
                            <Text style={styles.table_column_three}>{lab.uacr_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"The UACR"}</Text>
                            <Text style={styles.table_column_three}>{lab.the_uacr}</Text>
                            <Text style={styles.table_column_three}>{lab.mg_g_indicates}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
