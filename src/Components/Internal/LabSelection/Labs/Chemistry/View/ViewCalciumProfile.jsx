...
import PDFLab from '../PDF/PDFCalciumProfile';
import EditLab from '../Edit/EditCalciumProfile';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>s-Calcium (Total): </th>
                                    <td>{lab.s_calcium_total}</td>
                                    <th>Flag: </th>
                                    <td>{lab.s_calcium_total_flag}</td>
                                </tr>
                                <tr>
                                    <th>s-Ionized Calcium (Calc): </th>
                                    <td>{lab.s_ionized_calcium_calc}</td>
                                    <th>Flag: </th>
                                    <td>{lab.s_ionized_calcium_calc_flag}</td>
                                </tr>
                                <tr>
                                    <th>s-Albumin: </th>
                                    <td>{lab.s_albumin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.s_albumin_flag}</td>
                                </tr>
                                <tr>
                                    <th>s-Total Protein: </th>
                                    <td>{lab.s_total_protein}</td>
                                    <th>Flag: </th>
                                    <td>{lab.s_total_protein_flag}</td>
                                </tr>
                                <tr>
                                    <th>Corrected Calcium (Calc): </th>
                                    <td>{lab.corrected_calcium_calc}</td>
                                    <th>Comments: </th>
                                    <td>{lab.comments}</td>
                                </tr>
                                <tr>
