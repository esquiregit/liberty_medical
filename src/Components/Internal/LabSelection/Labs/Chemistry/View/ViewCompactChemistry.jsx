...
import PDFLab from '../PDF/PDFCompactChemistry';
import EditLab from '../Edit/EditCompactChemistry';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{lab.cholesterol_total}</td>
                                    <th>Flag: </th>
                                    <td>{lab.cholesterol_total_flag}</td>
                                </tr>
                                <tr>
                                    <th>Triglycerides: </th>
                                    <td>{lab.triglycerides}</td>
                                    <th>Flag: </th>
                                    <td>{lab.triglycerides_flag}</td>
                                </tr>
                                <tr>
                                    <th>HDL: </th>
                                    <td>{lab.hdl}</td>
                                ...
                                <tr>
                                    <th>Coronary Risk: </th>
                                    <td>{lab.coronary_risk}</td>
                                    <th>Flag: </th>
                                    <td>{lab.coronary_risk_flag}</td>
                                </tr>
                                <tr>
                                    <th>Uric Acid: </th>
                                    <td>{lab.uric_acid}</td>
                                    <th>Flag: </th>
                                    <td>{lab.uric_acid_flag}</td>
                                </tr>
                                <tr>
                                    <th>FBS: </th>
                                    <td>{lab.fbs}</td>
