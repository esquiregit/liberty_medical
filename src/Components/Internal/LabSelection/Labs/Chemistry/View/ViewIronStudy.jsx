...
import PDFLab from '../PDF/PDFIronStudy';
import EditLab from '../Edit/EditIronStudy';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Transferrin SAT: </th>
                                    <td>{lab.transferrin_sat}</td>
                                    <th>Flag: </th>
                                    <td>{lab.transferrin_sat_flag}</td>
                                </tr>
                                <tr>
                                    <th>Transferrin SAT: </th>
                                    <td>{lab.transferrin_sat}</td>
