...
import PDFLab from '../PDF/PDFProteinElectrophoresis';
import EditLab from '../Edit/EditProteinElectrophoresis';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Alpha 1 Globulin: </th>
                                    <td>{lab.alpha_1_globulin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.alpha_1_globulin_flag}</td>
                                </tr>
                                <tr>
                                    <th>Alpha 2 Globulin: </th>
                                    <td>{lab.alpha_2_globulin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.alpha_2_globulin_flag}</td>
                                </tr>
                                <tr>
                                    <th>Beta 1 Globulin: </th>
                                    <td>{lab.beta_1_globulin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.beta_1_globulin_flag}</td>
                                </tr>
                                <tr>
                                    <th>Beta 2 Globulin: </th>
                                    <td>{lab.beta_2_globulin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.beta_2_globulin_flag}</td>
                                </tr>
                                <tr>
                                    <th>Beta 2 Globulin: </th>
                                    <td>{lab.gamma_globulin}</td>
                                    <th>Flag: </th>
                                    <td>{lab.gamma_globulin_flag}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
