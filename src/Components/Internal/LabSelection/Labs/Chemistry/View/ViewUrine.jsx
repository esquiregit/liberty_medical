...
import PDFLab from '../PDF/PDFUrine';
import EditLab from '../Edit/EditUrine';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{lab.urine_vma}</td>
                                    <th>Urine Calcium: </th>
                                    <td>{lab.urine_calcium}</td>
                                </tr>
                                <tr>
                                    <th>Urine Uric Acid: </th>
                                    <td>{lab.urine_uric_acid}</td>
                                    <th>Urine Creatinine: </th>
                                    <td>{lab.urine_creatinine}</td>
                                </tr>
                                <tr>
                                    <th>Serum Creatinine: </th>
                                    <td>{lab.serum_creatinine}</td>
                                    <th>24Hr Urine Volume: </th>
                                    <td>{lab.twenty_four_hour_urine_volume}</td>
                                </tr>
                                <tr>
                                    <th>Clearance: </th>
                                    <td>{lab.clearance}</td>
