                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>FBC 3P</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_three}>{lab.wbc_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_three}>{lab.lym}</Text>
                            <Text style={styles.table_column_three}>{lab.lym_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"MID %"}</Text>
                            <Text style={styles.table_column_three}>{lab.mid}</Text>
                            <Text style={styles.table_column_three}>{lab.mid_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"GRAN %"}</Text>
                            <Text style={styles.table_column_three}>{lab.gran}</Text>
                            <Text style={styles.table_column_three}>{lab.gran_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"LYM #1"}</Text>
                            <Text style={styles.table_column_three}>{lab.lym_one}</Text>
                            <Text style={styles.table_column_three}>{lab.lym_one_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"MID #2"}</Text>
                            <Text style={styles.table_column_three}>{lab.mid_two}</Text>
                            <Text style={styles.table_column_three}>{lab.mid_two_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"GRAN #3"}</Text>
                            <Text style={styles.table_column_three}>{lab.gran_three}</Text>
                            <Text style={styles.table_column_three}>{lab.gran_three_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"RBC"}</Text>
                            <Text style={styles.table_column_three}>{lab.rbc}</Text>
                            <Text style={styles.table_column_three}>{lab.rbc_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"HGB"}</Text>
                            <Text style={styles.table_column_three}>{lab.hgb}</Text>
                            <Text style={styles.table_column_three}>{lab.hgb_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"HCT"}</Text>
                            <Text style={styles.table_column_three}>{lab.hct}</Text>
                            <Text style={styles.table_column_three}>{lab.hct_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"MCV"}</Text>
                            <Text style={styles.table_column_three}>{lab.mcv}</Text>
                            <Text style={styles.table_column_three}>{lab.mcv_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"MCHC"}</Text>
                            <Text style={styles.table_column_three}>{lab.mchc}</Text>
                            <Text style={styles.table_column_three}>{lab.mchc_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"RDW_CV"}</Text>
                            <Text style={styles.table_column_three}>{lab.rdw_cv}</Text>
                            <Text style={styles.table_column_three}>{lab.rdw_cv_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"RDW_SD"}</Text>
                            <Text style={styles.table_column_three}>{lab.rdw_sd}</Text>
                            <Text style={styles.table_column_three}>{lab.rdw_sd_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"PLT"}</Text>
                            <Text style={styles.table_column_three}>{lab.plt}</Text>
                            <Text style={styles.table_column_three}>{lab.plt_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"MPV"}</Text>
                            <Text style={styles.table_column_three}>{lab.mpv}</Text>
                            <Text style={styles.table_column_three}>{lab.mpv_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"PDW"}</Text>
                            <Text style={styles.table_column_three}>{lab.pdw}</Text>
                            <Text style={styles.table_column_three}>{lab.pdw_info}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"PCT"}</Text>
                            <Text style={styles.table_column_three}>{lab.pct}</Text>
                            <Text style={styles.table_column_three}>{lab.pct_info}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
