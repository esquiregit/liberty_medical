                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>NTC Screening</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"HB"}</Text>
                            <Text style={styles.table_column_two}>{lab.hb}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            ...
                            <Text style={styles.table_column_two}>{lab.hct}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Sickling"}</Text>
                            <Text style={styles.table_column_two}>{lab.sickling}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"HepB"}</Text>
                            <Text style={styles.table_column_two}>{lab.hepb}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
