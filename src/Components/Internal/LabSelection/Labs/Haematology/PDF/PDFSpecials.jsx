                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Specials</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"ABO Grouping"}</Text>
                            <Text style={styles.table_column_two}>{lab.abo_grouping}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"G6PD"}</Text>
                            <Text style={styles.table_column_two}>{lab.g6pd}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Sickling Test"}</Text>
                            <Text style={styles.table_column_two}>{lab.sickling}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"HGB Genotype"}</Text>
                            <Text style={styles.table_column_two}>{lab.hgb_genotype}</Text>
                        </View>
                    </View>
                </View>
            </Page>
