...
import PDFLab from '../PDF/PDFBloodFilmComment';
import EditLab from '../Edit/EditBloodFilmComment';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th colSPan="2">RBC: </th>
                                    <td colSPan="2">{lab.rbc}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">WBC: </th>
                                    <td colSPan="2">{lab.wbc}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">Platelets: </th>
                                    <td colSPan="2">{lab.platelets}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
