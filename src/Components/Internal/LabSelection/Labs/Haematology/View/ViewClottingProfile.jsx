...
import PDFLab from '../PDF/PDFClottingProfile';
import EditLab from '../Edit/EditClottingProfile';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Normal Plasma: </th>
                                    <td>{lab.normal_plasma}</td>
                                    <th>PT (INR): </th>
                                    <td>{lab.pt_inr}</td>
                                </tr>
                                <tr>
                                    <th>Control Time: </th>
                                    <td>{lab.control_time}</td>
                                    <th>Ratio: </th>
                                    <td>{lab.ratio}</td>
                                </tr>
                                <tr>
                                    <th>INR: </th>
                                    <td>{lab.inr}</td>
                                    <th>Factor VIII Assay: </th>
                                    <td>{lab.factor_viii_assay}</td>
                                </tr>
                                <tr>
                                    <th>Factor IX Activity: </th>
                                    <td>{lab.factor_ix_activity}</td>
                                    <th>Comments: </th>
                                    <td>{lab.comments}</td>
                                </tr>
                                <tr>
