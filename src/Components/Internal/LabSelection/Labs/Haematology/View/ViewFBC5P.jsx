...
import PDFLab from '../PDF/PDFFBC5P';
import EditLab from '../Edit/EditFBC5P';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{lab.neu_hash}</td>
                                    <th>Flag: </th>
                                    <td>{lab.neu_hash_flag}</td>
                                </tr>
                                <tr>
                                    <th>LYM #: </th>
                                    <td>{lab.lym_hash}</td>
                                    <th>Flag: </th>
                                    <td>{lab.lym_hash_flag}</td>
                                </tr>
                                <tr>
                                    <th>MON #: </th>
                                    <td>{lab.mon_hash}</td>
                                    <th>Flag: </th>
                                    <td>{lab.mon_hash_flag}</td>
                                </tr>
                                <tr>
                                    <th>EOS #: </th>
                                    <td>{lab.eos_hash}</td>
                                    <th>Flag: </th>
                                    <td>{lab.eos_hash_flag}</td>
                                </tr>
                                <tr>
                                    <th>BAS #: </th>
                                    <td>{lab.bas_hash}</td>
                                    <th>Flag: </th>
                                    <td>{lab.bas_hash_flag}</td>
                                </tr>
                                <tr>
                                    <th>NEU %: </th>
                                    <td>{lab.neu_percent}</td>
                                    <th>Flag: </th>
                                    <td>{lab.neu_percent_flag}</td>
                                </tr>
                                <tr>
                                    <th>LYM %: </th>
                                    <td>{lab.lym_percent}</td>
                                    <th>Flag: </th>
                                    <td>{lab.lym_percent_flag}</td>
                                </tr>
                                <tr>
                                    <th>MON %: </th>
                                    <td>{lab.mon_percent}</td>
                                    <th>Flag: </th>
                                    <td>{lab.mon_percent_flag}</td>
                                </tr>
                                <tr>
                                    <th>EOS %: </th>
                                    <td>{lab.eos_percent}</td>
                                    <th>Flag: </th>
                                    <td>{lab.eos_percent_flag}</td>
                                </tr>
                                <tr>
                                    <th>BAS %: </th>
                                    <td>{lab.bas_percent}</td>
                                    <th>Flag: </th>
                                    <td>{lab.bas_percent_flag}</td>
                                </tr>
                                <tr>
                                    <th>RBC: </th>
                                    <td>{lab.rbc}</td>
