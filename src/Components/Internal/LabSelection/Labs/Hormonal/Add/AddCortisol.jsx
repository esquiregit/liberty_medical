...
function AddCortisol({ patient, closeModal }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('cortisol'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'add_cortisol', values, { signal: signal })
            .then(response => {
