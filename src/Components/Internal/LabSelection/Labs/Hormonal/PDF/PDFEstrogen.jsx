                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Estrogen</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8}]}>
                            <Text style={styles.table_column_one}>{"Follicular"}</Text>
                            <Text style={styles.table_column_two}>{lab.follicular}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Mid Cycle"}</Text>
                            <Text style={styles.table_column_two}>{lab.mid_cycle}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Luteal"}</Text>
                            <Text style={styles.table_column_two}>{lab.luteal}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"PM"}</Text>
                            <Text style={styles.table_column_two}>{lab.pm}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Amenorrhoea"}</Text>
                            <Text style={styles.table_column_two}>{lab.amenorrhoea}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Mem"}</Text>
                            <Text style={styles.table_column_two}>{lab.mem}</Text>
                        </View>
