                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"LH"}</Text>
                            <Text style={styles.table_column_two}>{lab.lh}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"FSH"}</Text>
                            <Text style={styles.table_column_two}>{lab.fsh}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Prolactive"}</Text>
                            <Text style={styles.table_column_two}>{lab.prolactive}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Progesterone"}</Text>
                            <Text style={styles.table_column_two}>{lab.progesterone}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Oestrogen"}</Text>
                            <Text style={styles.table_column_two}>{lab.oestrogen}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"Testosterone"}</Text>
                            <Text style={styles.table_column_two}>{lab.testosterone}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
