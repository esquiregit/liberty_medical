                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>TFT</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"FT3"}</Text>
                            <Text style={styles.table_column_three}>{lab.ft3}</Text>
                            <Text style={styles.table_column_three}>{lab.ft3_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"FT4"}</Text>
                            <Text style={styles.table_column_three}>{lab.ft4}</Text>
                            <Text style={styles.table_column_three}>{lab.ft4_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"TSH"}</Text>
                            <Text style={styles.table_column_three}>{lab.tsh}</Text>
                            <Text style={styles.table_column_three}>{lab.tsh_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
