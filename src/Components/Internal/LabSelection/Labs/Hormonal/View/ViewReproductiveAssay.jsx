...
import PDFLab from '../PDF/PDFReproductiveAssay';
import EditLab from '../Edit/EditReproductiveAssay';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Prolactive: </th>
                                    <td>{lab.prolactive}</td>
                                    <th>Progesterone: </th>
                                    <td>{lab.progesterone}</td>
                                </tr>
                                <tr>
                                    <th>Oestrogen: </th>
                                    <td>{lab.oestrogen}</td>
                                    <th>Testosterone: </th>
                                    <td>{lab.testosterone}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
