...
function EditHPyloriAgSOB({ lab, closeModal, closeExpandable }) {
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_h_pylori_ag_sob', values, { signal: signal })
            .then(response => {
...
export default EditHPyloriAgSOB;
