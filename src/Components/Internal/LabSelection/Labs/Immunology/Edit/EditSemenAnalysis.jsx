...
function EditSemenAnalysis({ lab, closeModal, closeExpandable }) {
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_semen_analysis', values, { signal: signal })
            .then(response => {
...
export default EditSemenAnalysis;
