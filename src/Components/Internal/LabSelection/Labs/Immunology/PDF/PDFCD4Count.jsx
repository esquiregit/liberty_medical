                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>CD4Count</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            ...
                            <Text style={styles.table_column_three}>{lab.t_wbc}</Text>
                            <Text style={styles.table_column_three}>{lab.t_wbc_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"CD4 Count"}</Text>
                            <Text style={styles.table_column_three}>{lab.cd4_count}</Text>
                            <Text style={styles.table_column_three}>{lab.cd4_count_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"CD3"}</Text>
                            <Text style={styles.table_column_three}>{lab.cd3}</Text>
                            <Text style={styles.table_column_three}>{lab.cd3_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
                            <Text style={styles.table_column_one}>{"CD3/CD3"}</Text>
                            <Text style={styles.table_column_three}>{lab.cd4_cd3}</Text>
                            <Text style={styles.table_column_three}>{lab.cd4_cd3_flag}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
