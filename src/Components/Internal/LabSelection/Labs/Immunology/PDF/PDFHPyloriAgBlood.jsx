                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>H. Pylori Ag. Blood</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"H. Pylori Ag. (Blood)"}</Text>
                            <Text style={styles.table_column_two}>{lab.h_pylori_ag}</Text>
                        </View>
