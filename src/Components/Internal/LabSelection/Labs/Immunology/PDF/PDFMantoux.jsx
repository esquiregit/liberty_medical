                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Mantoux</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"Date of Injection"}</Text>
                            <Text style={styles.table_column_two}>{lab.date_of_injection}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"Date of Reading"}</Text>
                            <Text style={styles.table_column_two}>{lab.date_of_reading}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"Size of Induration in mm	"}</Text>
                            <Text style={styles.table_column_two}>{lab.size_of_induration}</Text>
                        </View>
