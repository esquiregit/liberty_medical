                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Pregnancy Test</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"Spcimen"}</Text>
                            <Text style={styles.table_column_two}>{lab.spcimen}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>Results</Text>
