                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Rheumatology</Text>
                        ...
                        <View style={[styles.table_column, {paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"LE Cells"}</Text>
                            <Text style={styles.table_column_two}>{lab.le_cells}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"ANA (Qualitative)"}</Text>
                            <Text style={styles.table_column_two}>{lab.ana_qualitative}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"ANA (Quantitative)"}</Text>
                            <Text style={styles.table_column_two}>{lab.ana_quantitative}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"ds DNA"}</Text>
                            <Text style={styles.table_column_two}>{lab.ds_dna}</Text>
                        </View>
                        <View style={[styles.table_column, {borderTop: 'transparent',paddingTop: 5,paddingBottom: 5}]}>
                            <Text style={styles.table_column_one}>{"Rheumatology Factor"}</Text>
                            <Text style={styles.table_column_two}>{lab.rheumatoid_factor}</Text>
                        </View>
