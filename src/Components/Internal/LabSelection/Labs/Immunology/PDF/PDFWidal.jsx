                ...
                <View style={styles.container}>
                    <View>
                        ...
                        <View style={styles.two_column}>
                            <Text style={styles.two_column_left}>Widal</Text>
                        ...
                        <View style={[styles.table_column, {borderTop: 'transparent',borderBottom: '1px solid #333', marginBottom: 5}]}>
                            ...
                            <Text style={[styles.table_column_two, {color: '#333', fontSize: 14}]}>TO</Text>
                            <Text style={[styles.table_column_two, {color: '#333', fontSize: 14}]}>TH</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Typhi"}</Text>
                            <Text style={styles.table_column_two}>{lab.typhi_to}</Text>
                            <Text style={styles.table_column_two}>{lab.typhi_th}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Paratyphi A"}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_a_to}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_a_th}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Paratyphi B"}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_b_to}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_b_th}</Text>
                        </View>
                        <View style={[styles.table_column, {backgroundColor: '#eee',paddingTop: 8,paddingBottom: 8,borderTop: 'transparent',}]}>
                            <Text style={styles.table_column_one}>{"Paratyphi C"}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_c_to}</Text>
                            <Text style={styles.table_column_two}>{lab.paratyphi_c_th}</Text>
                        </View>
                        <View style={[styles.table_column, {paddingTop: 8,paddingBottom: 8,borderTop: 'transparent'}]}>
