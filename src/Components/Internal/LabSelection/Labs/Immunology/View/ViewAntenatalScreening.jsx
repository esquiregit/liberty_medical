...
import PDFLab from '../PDF/PDFAntenatalScreening';
import EditLab from '../Edit/EditAntenatalScreening';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Blood Group: </th>
                                    <td>{lab.blood_group}</td>
                                    <th>Rh D: </th>
                                    <td>{lab.rhd}</td>
                                </tr>
                                <tr>
                                    <th>Antibody Screening: </th>
                                    <td>{lab.antibody_screening}</td>
                                    <th>HbsAG: </th>
                                    <td>{lab.hbsag}</td>
                                </tr>
                                <tr>
