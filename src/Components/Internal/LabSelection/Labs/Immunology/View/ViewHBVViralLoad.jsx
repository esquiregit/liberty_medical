...
import PDFLab from '../PDF/PDFHBVViralLoad';
import EditLab from '../Edit/EditHBVViralLoad';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th colSpan="2">HBV DNA: </th>
                                    <td colSpan="2">{lab.hbv_dna}</td>
                                </tr>
                                <tr>
                                    <th colSpan="2">PCR HBV Quantitative: </th>
                                    <td colSpan="2">{lab.pcr_hbv_quantitative}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
