...
import PDFLab from '../PDF/PDFHIVViralLoad';
import EditLab from '../Edit/EditHIVViralLoad';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th colSpan="2">HIV DNA: </th>
                                    <td colSpan="2">{lab.hiv_dna}</td>
                                </tr>
                                <tr>
                                    <th colSpan="2">PCR HIV Quantitative: </th>
                                    <td colSpan="2">{lab.pcr_hiv_quantitative}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
