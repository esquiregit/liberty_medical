...
import PDFLab from '../PDF/PDFHepatitisBProfile';
import EditLab from '../Edit/EditHepatitisBProfile';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colSPan="2">{lab.hbsag}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">HBsAb: </th>
                                    <td colSPan="2">{lab.hbsab}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">HBeAg: </th>
                                    <td colSPan="2">{lab.hbeag}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">HBeAb: </th>
                                    <td colSPan="2">{lab.hbeab}</td>
                                </tr>
                                <tr>
                                    <th colSPan="2">HBcAb: </th>
                                    <td colSPan="2">{lab.hbcab}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
