...
import PDFLab from '../PDF/PDFHepatitisMarkers';
import EditLab from '../Edit/EditHepatitisMarkers';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Hep A IgG Antibody: </th>
                                    <td>{lab.hep_a_igg_antibody}</td>
                                    <th>Hep B Core IgM Antibody: </th>
                                    <td>{lab.hep_b_core_igm_antibody}</td>
                                </tr>
                                <tr>
                                    <th>Hep A IgM Antibody: </th>
                                    <td>{lab.hep_a_igm_antibody}</td>
                                    <th>Hep Be Antigen: </th>
                                    <td>{lab.hep_be_antigen}</td>
                                </tr>
                                <tr>
                                    <th>Hep B s Antigen: </th>
                                    <td>{lab.hep_bs_antigen}</td>
                                    <th>Hep Be Antibody: </th>
                                    <td>{lab.hep_be_antibody}</td>
                                </tr>
                                <tr>
                                    <th>Hep B s Antibody: </th>
                                    <td>{lab.hep_bs_antibody}</td>
                                    <th>Hep C Screen: </th>
                                    <td>{lab.hep_c_screen}</td>
                                </tr>
                                <tr>
                                    <th>Hep B Core IgG Antibody: </th>
                                    <td>{lab.hep_b_core_igg_antibody}</td>
                                    <th>Comments: </th>
                                    <td>{lab.comments}</td>
                                </tr>
                                <tr>
