...
import PDFLab from '../PDF/PDFMantoux';
import EditLab from '../Edit/EditMantoux';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{lab.date_of_injection}</td>
                                    <th>Date of Reading: </th>
                                    <td>{lab.date_of_reading}</td>
                                </tr>
                                <tr>
                                    <th>Size of Induration in mm: </th>
                                    <td>{lab.size_of_induration}</td>
                                    <th>Comments: </th>
                                    <td>{lab.comments}</td>
                                </tr>
                                <tr>
