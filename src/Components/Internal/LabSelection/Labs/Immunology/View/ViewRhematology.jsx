...
import PDFLab from '../PDF/PDFRhematology';
import EditLab from '../Edit/EditRheumatology';
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>LE Cells: </th>
                                    <td>{lab.le_cells}</td>
                                    <th>ANA (Qualitative): </th>
                                    <td>{lab.ana_qualitative}</td>
                                </tr>
                                <tr>
                                    <th>ANA (Quantitative): </th>
                                    <td>{lab.ana_quantitative}</td>
                                    <th>ds DNA: </th>
                                    <td>{lab.ds_dna}</td>
                                </tr>
                                <tr>
                                    <th>Rheumatoid Factor: </th>
                                    <td>{lab.rheumatoid_factor}</td>
                                    <th>Comments: </th>
                                    <td>{lab.comments}</td>
                                </tr>
                                <tr>
