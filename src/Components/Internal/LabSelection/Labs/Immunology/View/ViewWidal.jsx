...
import PDFLab from '../PDF/PDFWidal';
import EditLab from '../Edit/EditWidal';
                    ...
                    <div className="detail-div">
                        ...
                        <table id="detail-table">
                            <tbody>
                                ...
                                <tr>
                                    <th>Paratyphi A TO: </th>
                                    <td>{lab.paratyphi_a_to}</td>
                                    <th>Paratyphi A TH: </th>
                                    <td>{lab.paratyphi_a_th}</td>
                                </tr>
                                <tr>
                                    <th>Paratyphi B TO: </th>
                                    <td>{lab.paratyphi_b_to}</td>
                                    <th>Paratyphi B TH: </th>
                                    <td>{lab.paratyphi_b_th}</td>
                                </tr>
                                <tr>
                                    <th>Paratyphi C TO: </th>
                                    <td>{lab.paratyphi_c_to}</td>
                                    <th>Paratyphi C TH: </th>
                                    <td>{lab.paratyphi_c_th}</td>
                                </tr>
                                <tr>
                                    <th>Comments: </th>
