...
function EditCA125({ lab, closeModal, closeExpandable }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('CA125'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_ca_one_two_five', values, { signal: signal })
            .then(response => {
                if(response.data[0].status.toLowerCase() === 'success') {
                    setSuccess(true);
                    setMessage(response.data[0].message);
                    setTimeout(() => { closeModal('CA125'); }, 1050);
                } else {
                    setError(true);
                    setMessage(response.data[0].message);
                }
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td className="text-centre pt-20 pb-20" colSpan="5">
                                                -Use in monitoring of epithelial ovarian cancer treatment. -May be also elevated in patients with cervical, fallopian tubes and uterine cancer and endometriosis.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Comments</td>
