...
function EditCRP({ lab, closeModal, closeExpandable }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('CRP'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_crp', values, { signal: signal })
            .then(response => {
                if(response.data[0].status.toLowerCase() === 'success') {
                    setSuccess(true);
                    setMessage(response.data[0].message);
                    setTimeout(() => { closeModal('CRP'); }, 1050);
                } else {
                    setError(true);
                    setMessage(response.data[0].message);
                }
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td className="text-centre pt-20 pb-20" colSpan="5">
                                                Increase in Myocardial Tissue Injury (AMI: Acute Myocardial Infarction)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Comments</td>
