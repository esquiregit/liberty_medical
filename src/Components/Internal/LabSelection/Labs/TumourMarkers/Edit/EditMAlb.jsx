...
function EditMAlb({ lab, closeModal, closeExpandable }) {
    ...
    const handleClose  = () => { setOpen(false); closeModal('MAlb'); };
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_m_alb', values, { signal: signal })
            .then(response => {
                if(response.data[0].status.toLowerCase() === 'success') {
                    setSuccess(true);
                    setMessage(response.data[0].message);
                    setTimeout(() => { closeModal('MAlb'); }, 1050);
                } else {
                    setError(true);
                    setMessage(response.data[0].message);
                }
                                ...
                                <table id="lab-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            Increase in: -Diabetic mellitus, -Chronic and acute renal disease.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Comments</td>
