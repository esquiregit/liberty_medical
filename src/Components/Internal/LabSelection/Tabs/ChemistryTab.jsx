...
import AddISE from '../Labs/Chemistry/Add/AddISE';
import AddLFT from '../Labs/Chemistry/Add/AddLFT';
import AddHBA1C from '../Labs/Chemistry/Add/AddHBA1C';
import AddUrine from '../Labs/Chemistry/Add/AddUrine';
import AddBueLFT from '../Labs/Chemistry/Add/AddBueLFT';
import AddSC3SC4 from '../Labs/Chemistry/Add/AddSC3SC4';
import AddUrineACR from '../Labs/Chemistry/Add/AddUrineACR';
import AddBueLipids from '../Labs/Chemistry/Add/AddBueLipids';
import AddFolateB12 from '../Labs/Chemistry/Add/AddFolateB12';
import AddIronStudy from '../Labs/Chemistry/Add/AddIronStudy';
import AddBloodSugar from '../Labs/Chemistry/Add/AddBloodSugar';
import AddCSFBiochem from '../Labs/Chemistry/Add/AddCSFBiochem';
import AddSerumLipase from '../Labs/Chemistry/Add/AddSerumLipase';
import AddLipidProfile from '../Labs/Chemistry/Add/AddLipidProfile';
import AddBueCreatinine from '../Labs/Chemistry/Add/AddBueCreatinine';
import AddCardiacEnzyme from '../Labs/Chemistry/Add/AddCardiacEnzyme';
import AddCalciumProfile from '../Labs/Chemistry/Add/AddCalciumProfile';
import AddGeneralChemistry from '../Labs/Chemistry/Add/AddGeneralChemistry';
import AddCReactiveProtein from '../Labs/Chemistry/Add/AddCReactiveProtein';
import AddCompactChemistry from '../Labs/Chemistry/Add/AddCompactChemistry';
import AddBueCreatinineEgfr from '../Labs/Chemistry/Add/AddBueCreatinineEgfr';
import AddHypersensitiveCPR from '../Labs/Chemistry/Add/AddHypersensitiveCPR';
import AddProteinElectrophoresis from '../Labs/Chemistry/Add/AddProteinElectrophoresis';
