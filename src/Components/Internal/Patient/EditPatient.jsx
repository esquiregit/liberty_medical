...
function EditPatient({ patient, closeEditModal, closeExpandable }) {
    ...
    const initialValues = {
        ...
        date_of_birth      : patient.date_of_birth_raw,
    ...
    const onSubmit     = () => {
        ...
        Axios.post(getBaseURL()+'edit_patient', values, { signal: signal })
            .then(response => {
                    ...
                    {({ isValid, dirty, resetForm }) => (
                        <Form>
                            ...
                            <DialogActions>
                                ...
                                <Tippy content="Update Patient Details">
                                    <Button
                                        type="submit"
